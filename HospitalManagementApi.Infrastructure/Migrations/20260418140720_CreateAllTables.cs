    ...
    public partial class CreateAllTables : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ConsultationPayments", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ConsultationPayments_Consultations_ConsultationId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Tests_Consultations_ConsultationId",
                        column: x => x.ConsultationId,
                        principalTable: "Consultations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PatientId = table.Column<int>(type: "integer", nullable: false),
                    HealthParameter = table.Column<decimal>(type: "numeric", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TestPayments", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TestPayments_Tests_TestId",
                        column: x => x.TestId,
                        principalTable: "Tests",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ConsultationPayments_ConsultationId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TestPayments_TestId",
                table: "TestPayments",
                column: "TestId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Tests_ConsultationId",
                table: "Tests",
                column: "ConsultationId");
